 ...
 *
 * @param {String} deviceid of the form '<domain>:<name>'
...
Organiq.prototype.getDeviceAuthority = function getDeviceAuthority(deviceid) {
  ...
  try {
    authority.deviceid = deviceid.toLowerCase();
    authority.domain = deviceid.toLowerCase().split(':')[0];
